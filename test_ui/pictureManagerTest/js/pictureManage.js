			...
			if(codeKey === numKeyDown){
				...
				if(currentMode === 3){
					switch(currentRow){
						...
						changeContrast(0);
						//设置对比度
						PictureManager.setContrast();
						break;
					case 2:
						changeBright(0);
						//设置亮度
						PictureManager.setBrightness();
						break;
					case 3:
						changeColor(0);
						//设置饱和度
						PictureManager.setSaturation();
						break;
					/*case 5:
					...
					case 4:
						changeSharp(0);
						//设置图像清晰度
						PictureManager.setSharpness();
						break;
					case 5:
						changeTint(0);
						//设置图像色调
						PictureManager.setTint();
						break;
					case 6:
						changeBack(0);
						//设置背光
						PictureManager.setbacklight();
						break;
					}
				}
